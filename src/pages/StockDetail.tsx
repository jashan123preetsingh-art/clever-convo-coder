...
function AIFundamentalsPanel({ symbol, quote, technicals, partialFundamentals }: { symbol: string; quote: any; technicals: any; partialFundamentals: any }) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Available Metrics (from partial data) */}
